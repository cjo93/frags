...
const tiers = [
  {
    ...
    key: 'insight',
    price: 15,
    description: 'Begin understanding your patterns.',
    features: [
      'Natal profile creation',
  ...
  },
  {
    ...
    key: 'integration',
    price: 29,
    description: 'Deepen with temporal awareness.',
    features: [
      'Everything in Insight',
      'Transit timing windows',
      'State model computation',
      'Temporal overlays',
      'AI preview responses',
    ],
  ...
  },
  {
    ...
    key: 'constellation',
    price: 59,
    description: 'Map your relational field.',
    features: [
      'Everything in Integration',
      'Create constellations',
      'Family system mapping',
      'Bowen theory integration',
      'Full AI synthesis',
    ],
