...
const tiers = [
  {
    ...
    key: 'insight',
    price: 15,
    description: 'Individual clarity, self-exploration.',
    features: [
      'Up to 3 profiles',
      'Deterministic synthesis (readings, states)',
      'AI preview (truncated responses)',
      'Dashboard + history',
    ],
  ...
  },
  {
    ...
    key: 'integration',
    price: 29,
    description: 'Systems-level understanding.',
    features: [
      'Unlimited profiles',
      'Systems + check-ins',
  ...
  },
  {
    ...
    key: 'constellation',
    price: 59,
    description: 'Full relational intelligence + AI synthesis.',
    features: [
      'Full constellation creation + compute',
      'Full AI synthesis (no truncation)',
      'AI across profiles + constellations',
      'Priority compute',
    ],
