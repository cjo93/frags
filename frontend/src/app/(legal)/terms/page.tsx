...
export const metadata: Metadata = {
  title: "Terms of Service — Plain-Language Agreement",
  description: "Defrag is software for reflection, not therapy or medical advice. You control your data. We limit abuse and maintain availability.",
};
